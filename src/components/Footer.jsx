...
const Footer = () => {
  return (
    <div>
      ...
      <hr />
      <footer className="text-xs gap-4 md:gap-10 md:text-sm footer flex justify-center items-center xl:px-24 px-4 py-4 mt-2">
        <aside className="items-center grid-flow-col">
          <p>Copyright © 2023 - All right reserved</p>
        </aside>
        <nav className="flex gap-4 md:place-self-center md:justify-between">
          <a>
            <svg
